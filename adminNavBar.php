     ...
     <div class="container bg-info border-primary rounded-4">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                 ...
                 <li class="nav-item me-5">
                     <a class="nav-link active" aria-current="page" href="adminProducts.php">Product Management</a>
                 </li>
                 ...
                 <li class="nav-item me-5">
                     <a class="nav-link active" aria-current="page" href="adminUserReportPrint.php">Reports</a>
                 </li>
