...
if ($num > 0) {
    ...
    try {
        ...
        $mail->Username = 'pramudithalakshan00@gmail.com';                     //SMTP username
        $mail->Password = 'luvnppfstwyxxyzz';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('pramudithalakshan00@gmail.com', 'FruitVista');
                                        ...
                                        <table style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); padding: 40px; margin: 20px 0;">
                                            <tr>
                                                <td align="center" style="padding-bottom: 20px;">
                                                    <a href="#" style="font-size: 35px; font-weight: bold; color: #333; text-decoration: none;">FruitVista</a>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding-top: 20px;">
                                                    <p style="color: #666; font-size: 14px;">© 2024 FruitVista</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
